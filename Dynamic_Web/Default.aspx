...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- Carousel Start -->
    <div class="container-fluid p-0 pb-0"  style="position:relative;">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative" runat="server" id="slider1Id" style="">
                <asp:Image ID="ImageSlider1" runat="server" class="img-fluid" alt="" />
                <%--<div class="position-absolute top-0 start-0 w-100 h-100 d-flex" style="color:black;">
                    <div class="container">
                        <div class="row" style="text-align:center;position:relative;top:20vh">
            ...
            <div class="owl-carousel-item position-relative"  runat="server" id="slider2Id" style="">
                <asp:Image ID="ImageSlider2" class="img-fluid" alt="" runat="server" />
                <%--<div class="position-absolute top-0 start-0 w-100 h-100 d-flex " style="color:black;">
                    <div class="container">
                        <div class="row" style="text-align:center;position:relative;top:20vh">
                            <div class="col-6 text-center" style="color:black;">
            ...
            <div class="owl-carousel-item position-relative" runat="server" id="slider3Id" style="">
                <asp:Image ID="ImageSlider3" class="img-fluid" alt="" runat="server" />
                <%--<div class="position-absolute top-0 start-0 w-100 h-100 d-flex" style="color:black">
                    <div class="container">
                        <div class="row" style="text-align:center;position:relative;top:20vh">
                            <div class="col-6 text-center" style="color:black;">
    ...
    <section class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                <h1 id="homeSection2Heading" class="text-center mt-5 pt-3 head_text" style="margin-top: 2%;" runat="server"></h1>
                <hr />
            </div>
            <div class="col-lg-12 col-sm-12">
        ...
        <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative w-90 h-90">
                            <asp:Image ID="HomeSection2img1"  AlternateText="Error" class="img-fluid" style="height:80%;width:80%;margin-left:50px;" runat="server" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative w-90 h-90">
                            <asp:Image ID="HomeSection2img2"  AlternateText="Error" class="img-fluid " style="height:80%;width:80%;margin-left:50px;" runat="server" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative w-90 h-90">
                            <asp:Image ID="HomeSection2img3"  AlternateText="Error" class="img-fluid " style="height:80%;width:80%;margin-left:50px;" runat="server" />
                        </div>
                    </div>
                </div>
            <center><a href="#" id="btnlink" class="btn btn-primary py-2 px-2" style="width:200px;border-radius:15px;margin-top:10px" runat="server">Learn More</a></center>
            </div>
    </section>
    ...
    <div class="container-xxl py-5" style="text-align:center">
        <div class="container" >
            <div class="section-title text-center">
                <h1 class="display-5 mb-2" runat="server" id="section3Heading"></h1>
                <hr />
            </div>
            <div class="row">
    ...
    <!-- Feature Start -->
    <<div class="container-fluid overflow-hidden my-0 px-lg-1">
         <div class="container-fluid overflow-hidden my-0 px-lg-1">
        <div class="container about px-lg-1">
            <div class="section-title text-center">
    ...
    <div class="container-xxl" >
        <div class="container" style="text-align:center;">
            <div class="section-title text-center">
                <h1 class="display-5 mb-0" runat="server" id="lblTeamHeader"> OUR TEAM MEMBER</h1>
                <hr />
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-2 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative">
                            <asp:Image ID="Image1Team" class="img-fluid" alt=""  runat="server" style="height:auto;width:95%"  />
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative">
                            <asp:Image ID="Image2Team" class="img-fluid" alt=""  runat="server" style="height:auto;width:95%"  />
                            <div class="team-social">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative">
                            <asp:Image ID="Image3Team" class="img-fluid" alt=""  runat="server" style="height:auto;width:95%"  />
                            <div class="team-social">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item text-center">
                    <asp:Image ID="TestmonialImage1" class="img-fluid bg-light p-2 mx-auto mb-3" alt="" style="width: 100px !important; height: 100px !important;" runat="server"  />
                ...
                <div class="testimonial-item text-center">
                    <asp:Image ID="TestmonialImage2" class="img-fluid bg-light p-2 mx-auto mb-3" alt="" style="width: 100px !important; height: 100px !important" runat="server"  />
                    <div class="testimonial-text text-center p-4">
                ...
                <div class="testimonial-item text-center">
                    <asp:Image ID="TestmonialImage3" class="img-fluid bg-light p-2 mx-auto mb-3" alt="" style="width: 100px !important; height: 100px !important;" runat="server"  />
                    <div class="testimonial-text text-center p-4">
